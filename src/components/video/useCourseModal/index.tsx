...
function useCourseModal() {
                ...
                <Modal>
                    <S.CourseModalContainer>
                        <S.CourseModalHeader>
                            ...
                            <S.ModalInfoText>“{data?.courseName}" 일정에 Day {data?.day}을 추가했어요!</S.ModalInfoText>
                        </S.CourseModalHeader>
                        <S.TravelList>
                            <S.TravelListHeader>
    ...
    return {CourseModal, courseModalOpen : modalOpen, courseModalClose : modalClose, setCourseModalData};
}
