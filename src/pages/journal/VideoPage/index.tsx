  ...
  return (
    ...
    >
      ...
      <S.Contents>
        ...
        <S.Explain>
          여러분 안녕하세요! 오늘은 여행 브이로그를 가져왔습니다. 2023 올해 제 목표가 일단 시작,
          일단 출발 이거든요! 망설이기만 하다가가는 아무것도 못하잖아요 그래서 올해는 너무 깊이
          생각하지 않고 뭐든 일단! 해보는 걸로 정했습니다! 그래서 떠난 부산 여행! 모두가 말렸던 부산
          당일치기를!!!! 제가 해냈습니다!!!! 후훗😎 그럼 오늘 영상도 재밌게 봐주세요!💙
        </S.Explain>
      </S.Contents>
